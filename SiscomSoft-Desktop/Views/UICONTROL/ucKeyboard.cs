...
namespace SiscomSoft_Desktop.Views.UICONTROL
{
    public partial class ucKeyboard : UserControl
    {
        ...
        {
            btnEscape.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero1.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero2.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero3.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero4.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero5.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero6.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero7.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero8.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero9.BackColor = Color.Cyan;
        }
        ...
        {
            btnNumero0.BackColor = Color.Cyan;
        }
        ...
        {
            btnArroba.BackColor = Color.Cyan;
        }
        ...
        {
            btnCorcheteizq.BackColor = Color.Cyan;
        }
        ...
        {
            btnMayusIzqu.BackColor = Color.Cyan;
        }
        ...
        {
            btnCorcheteDerech.BackColor = Color.Cyan;
        }
        ...
        {
            btnMayusDere.BackColor = Color.Cyan;
        }
        ...
        private void btnEspacio_MouseMove(object sender, MouseEventArgs e)
        {
            btnEspacio.BackColor = Color.Cyan;
        }

        private void btnEspacio_MouseLeave(object sender, EventArgs e)
        {
            btnEspacio.BackColor = Color.White;
        }

        private void button57_MouseMove(object sender, MouseEventArgs e)
        {
            btnAltGr.BackColor = Color.Cyan;
        }
