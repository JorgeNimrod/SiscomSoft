namespace SiscomSoft.Migrations
{
    ...
    public partial class INICIAL : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        dGasto = c.Decimal(nullable: false, precision: 18, scale: 2),
                        dTotal = c.Decimal(nullable: false, precision: 18, scale: 2),
                        dPrecioVenta = c.Decimal(nullable: false, precision: 18, scale: 2),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Almacenes", "fkProducto_pkProducto", "dbo.Productos");
            ...
            DropForeignKey("dbo.Almacenes", "fkImpuesto_pkImpuesto", "dbo.Impuestos");
            ...
            DropForeignKey("dbo.Almacenes", "fkCatalogo_pkCatalogo", "dbo.Catalogos");
            ...
            DropIndex("dbo.Almacenes", new[] { "fkProducto_pkProducto" });
            DropIndex("dbo.Almacenes", new[] { "fkImpuesto_pkImpuesto" });
            DropIndex("dbo.Almacenes", new[] { "fkCliente_pkCliente" });
            DropIndex("dbo.Almacenes", new[] { "fkCatalogo_pkCatalogo" });
