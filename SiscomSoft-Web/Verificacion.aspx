<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Verificacion.aspx.cs" Inherits="WebApplication1.Verificacion" %>
        ...
        <div class="section">
	    	<div class="container">
				...
				<div class="col-sm-12"><br /><br /><br />
						<h2>Su cuenta fue verificada con éxito.</h2>
						<h3>Para recibir un usuario y una contraseña para ingresar a nuestro sitio de clic en el siguiente enlace: </h3>
			    ...
			    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Obtener usuario y contraseña." />
			</div>
		</div>
